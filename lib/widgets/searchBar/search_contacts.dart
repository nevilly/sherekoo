...
class SearchContants extends StatefulWidget {
  const SearchContants({Key? key}) : super(key: key);

  @override
  State<SearchContants> createState() => _SearchContantsState();
}

class _SearchContantsState extends State<SearchContants> {
  ...
  Widget build(BuildContext context) {
    ...
    Autocomplete<User>(
      optionsBuilder: (TextEditingValue value) {
        ...
        return data
            .where((d) =>
                d.phoneNo!.toLowerCase().contains(value.text.toLowerCase()))
            .toList();
      },
