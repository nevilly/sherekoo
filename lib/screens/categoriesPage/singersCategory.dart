...
class SingersCategory extends StatefulWidget {
  const SingersCategory({Key? key}) : super(key: key);

  @override
  _SingersCategoryState createState() => _SingersCategoryState();
}

class _SingersCategoryState extends State<SingersCategory> {
